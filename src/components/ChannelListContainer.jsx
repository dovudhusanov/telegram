...
function ChannelListContent({isCreating, setIsCreating, isEditing, setIsEditing, setCreateType, setToggleContainer}) {
    ...
    return (
        <>
            ...
            <div className="channel-list__container-responsive"
                style={{left: toggleContainer ? "0%" : "-90%", background: "#005fff"}}
            >
